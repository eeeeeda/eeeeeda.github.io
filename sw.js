...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-b1e921e22ac543402d80.js"
  },
  {
  ...
  {
    "url": "app-0212acf4b0d338d7bd53.js"
  },
  {
    "url": "offline-plugin-app-shell-fallback/index.html",
    "revision": "dfe0b39ccd7588361317248589a0672f"
  },
  {
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  if (!resources || !(await caches.match(`/app-0212acf4b0d338d7bd53.js`))) {
    return await fetch(event.request)
  }
